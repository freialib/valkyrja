...
module.exports = function (cwd, args, draftdir) {
	...
	console.log(gutter + indent + c.magenta('help') + '       - help page');
	console.log('');
	console.log('-----------------------------------------------------------------------');
	console.log('');
	...
	console.log(gutter + 'You may pass type and category but host will be set to null.');
	console.log('')
	console.log(' ' + c.bold.dim.underline('Command') + ': ' + c.magenta('export'));
	console.log('')
	console.log(gutter + 'Create container or other packaged solution.');
	console.log(gutter + 'Your container build logic needs to be defined in the '+c.dim('.valkyrja.js')+'.');
	console.log('')
	console.log(' ' + c.bold.dim.underline('Command') + ': ' + c.magenta('send'));
	console.log('')
	console.log(gutter + 'Deploy container or other packaged solution.');
	console.log(gutter + 'Command does not imply automatic excution of '+c.dim('valk export')+'.');
	console.log(gutter + 'Your container send logic needs to be defined in the '+c.dim('.valkyrja.js')+'.');
	console.log('')
